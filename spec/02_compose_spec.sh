Describe "Compose"
  ...
  Describe "ClearLinux"
    ...
    # It "installed compose at precise version"
    #   When call compose clearlinux 1.25.3
    #   The status should be success
    #   The output should include 1.25.3
    #   The error should match pattern '*'
    # End
    ...
    # It "installed compose with proper sha256 sum"
    #   When call compose clearlinux 1.25.3 b3835d30f66bd3b926511974138923713a253d634315479b9aa3166c0050da98
    #   The status should be success
    #   The output should include 1.25.3
    #   The error should match pattern '*'
    # End
    ...
    # # need to select and install the proper set of dependency packages.
    # It "installed compose with improper sha256 sum"
    #   When call compose clearlinux 1.25.3 b3835d30f66bd3b926511974138923713a253d634315479b9aa3166c00000000
    #   The status should be success
    #   The output should include 1.25.3
    #   The error should match pattern '*'
    # End
